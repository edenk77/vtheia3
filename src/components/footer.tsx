        ...
        <footer className="bg-black dark:bg-gray-900 text-white ">
            <div className="mx-auto w-full p-4 py-6 lg:py-8 ">
                <div className="md:flex md:justify-between p-6">
                    <div className="mb-6 md:mb-0">
                        <Link to={"/Contact"} className="flex items-center">
                            <ApplicationLogo className="h-10 mr-6 ml-10" />
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="font-medium">
                                ...
                                <li>
                                    <Link to={"/Terms"} className="hover:underline">Termes &amp; Conditions</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between mx-6">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" className="hover:underline">Voytheia™</a>. All Rights Reserved.
                    </span>
